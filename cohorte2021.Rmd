...
![](plots_2021/Julieta_Couto_plot.jpg)
...
![](plots_2021/Luciano_Pamela_plot.jpeg)
...
![](plots_2021/Manuel_Emilio_Lopez_plot2.png)
...
pie3D(Gastos_quintil_uno$porcentaje)
```


![](plots_2021/Marcela_Almeida_plot2.png)
...
ggplot(pinguinos, aes(largo_pico_mm, largo_aleta_mm))+
  ...
  geom_segment(aes(x= 45, y= 200, xend= 40, yend = 175),
             ...
             color = "darkred",
             curvature = 0.2)+
  geom_density_2d(aes(color= especie), size = 1)
```

![](plots_2021/Martin_Saralegui_plot.jpg)
...
![](plots_2021/Mercedes_Laurenza_plot.png)
